...
export const DraggableItem = ({ item }: DraggableItemProps) => {
  ...
  useEffect(() => {
    ...
    const handleMouseUp = () => {
      ...
      // Adjust elevation based on corner heights after dragging
      if (isDragging) {
  ...
  }, [isDragging, isRotating, rotationStartX, rotationStart, item, updatePlacedItem, adjustItemElevationToCorners, camera, scene, gl, placedItems, terrainHeightMap]);
